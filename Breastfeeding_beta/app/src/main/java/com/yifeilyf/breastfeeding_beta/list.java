...
public class list extends Activity {
    ...
    private JSONObject formatFeed(Feed newFeed) throws JSONException{
        ...
        //before.put(jsonObject);
        //jsonObject = new JSONObject();
        before.put("weight", (int)newFeed.getWeightBefore());
        //beforeArray.put(jsonObject);
        //jsonObject = new JSONObject();
        ...
        //jsonObject = new JSONObject();
        after.put("weight", (int)newFeed.getWeightAfter());
        //afterArray.put(jsonObject);
        //jsonObject = new JSONObject();
    ...
    private Boolean initialise(String feedData) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                //Create and add calendar objects
                ...
                startCal.setTime(sdf.parse(data.getJSONObject("after").getString("date")));
                feed.putEndCal(endCal);

                //Add weights
                feed.putWeightBefore(Double.parseDouble(data.getJSONObject("before").getString("weight")));
                feed.putWeightAfter(Double.parseDouble(data.getJSONObject("after").getString("weight")));
